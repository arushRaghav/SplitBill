...
function App(){
    ...
    function handleSplitBill(value){
        setFriends(friends => friends.map(friend => friend.id === selectedFriend?.id ? {...friend, 
            balance: friend.balance + value } : friend
        ));
    }
    ...
    return (
        <div className="app">
            ...
            {selectedFriend && <FormSplitBill selectedFriend={selectedFriend} key={selectedFriend.id}
